#ifndef WISCO_AUTONS_Orange_ELIM_AUTON_HPP
#define WISCO_AUTONS_Orange_ELIM_AUTON_HPP
...
/**
 * @brief The auton for the Orange robot in elimes
 * @author Nathan Sandvig
 * 
 */
class OrangeElimAuton : public IAutonomous
{
private:
	/**
	 ...
	 * 
	 */
	static constexpr char AUTONOMOUS_NAME[]{"E_ORANGE"};
